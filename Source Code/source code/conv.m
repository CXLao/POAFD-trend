function [an,coef,t]=conv(s,max_level,M,varargin)
% Algorithm based on the conventional exhaustive basis searching 
%
% [an,coef,t]=FFT(s,max_level,M)
% [an,coef,t]=conv(s,max_level,M,L)
%
% Desciptions:
%   (1) [an,coef,t]=conv(s,max_level,M): decomposes signal s to max_level
...
%       the signal s.
%   (2) [an,coef,t]=conv(s,max_level,M,L): Same as (1) but the phase
