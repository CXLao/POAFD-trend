function [XX,YY,ObjFun,an_x,an_y,ObjFun_an,reduced_reminder,standard_reminder]=ObjFun(s,max_level,M,varargin)
% Calculate objective function values of the algorithm in each decomposition level
%
% [XX,YY,ObjFun,an_x,an_y,ObjFun_an]=ObjFun(s,max_level,M)
% [XX,YY,ObjFun,an_x,an_y,ObjFun_an]=ObjFun(s,max_level,M,L)
%
% Desciptions:
%   (1) [XX,YY,ObjFun,an_x,an_y,ObjFun_an]=ObjFun(s,max_level,M): Calculate 
...
%   (2) [XX,YY,ObjFun,an_x,an_y,ObjFun_an]=ObjFun(s,max_level,M,L): Same as (1) but the phase
